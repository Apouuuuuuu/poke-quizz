          ...
          <div className="flex flex-col space-y-4">
            ...
            >
              <div className="flex flex-col">
                <span>PhotoQuiz</span>
                <span className="text-xs font-normal">Devine le Pokémon à partir d'une image</span>
              </div>
            </button>
            <button
            ...
            >
              <div className="flex flex-col">
                <span>SoundQuiz</span>
                <span className="text-xs font-normal">Devine le Pokémon à partir de son cri</span>
              </div>
            </button>
            <button
